...
import gorovyi.seleniumBrowserTest.Site;
...
public class ScenariesTest {
    ...
    public void BuyTshirtAndCheckingPriceTest(){
        ...
        actualPrice = Double.valueOf(webDriver
                .findElement(By.xpath("//*[@id=\"product_price_1_1_327127\"]/span"))
                .getText()
                .substring(1));//Убираем знак "$"
    ...
    public void checkDiscountTest(){
        ...
        actualDiscount = Integer.valueOf(webDriver
                .findElement(By.xpath("//*[@id=\"center_column\"]/ul/li[1]/div/div[2]/div[1]/span[3]"))
                .getText()
                .substring(1,3));//Убираем знак "%"
